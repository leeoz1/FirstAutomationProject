...
*/
    ...
    @Test(description = "test 08 - Verify Logo")
    @Description("This test verifies the web's logo using sikulix tool and logout")
    public void test08_VerifyWebLogo() throws FindFailed {
